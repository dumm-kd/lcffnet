...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data/val/images")
    parser.add_argument("--mask-dir", default="data/val/masks")
    parser.add_argument("--output-img-dir", default="data/potsdam/val/images_1024")
    parser.add_argument("--output-mask-dir", default="data/potsdam/val/masks_1024")
...
def image_augment(image, mask, patch_size, mode='test', val_scale=1.0):
    image_list = []
    mask_list = []
        ...
        for y in range(0, img.shape[0], stride):
            for x in range(0, img.shape[1], stride):
                ...
                if img_tile.shape[0] == split_size and img_tile.shape[1] == split_size \
                    ...
                    if cf[4] > 1.0 and mode == 'test':  # ignore car_aug, no improvement
