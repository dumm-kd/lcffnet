...
def parse_args():
    ...
    parser.add_argument("--output-img-dir", default="data/vaihingen/test/images_1024")

    parser.add_argument("--output-mask-dir", default="data/vaihingen/test/masks_1024")
...
def vaihingen_format(inp):
    ...
    if eroded:
        ...
        # mask_path = r"E:\pyproject\GeoSeg-main\tools\data\noBoundries"
