...
def parse_args():
    ...
    parser.add_argument("--input-dir", default="data/uavid/uavid_train")
    parser.add_argument("--output-img-dir", default="data/uavid/train/images")
    parser.add_argument("--output-mask-dir", default="data/uavid/train/masks")
...
def image_augment(image, mask, mode='test'):
    image_list = []
    mask_list = []
