...
from geoseg.models.ablation.CoTFormer import CoTFormer
...
# pretrained_ckpt_path = "model_weights/potsdam/cotformer-e100/cotformer-e100.ckpt"  # the path for the pretrained model weight
...
#  define the network
net = CoTFormer(num_classes=num_classes)
...
test_dataset = PotsdamDataset(data_root='data/potsdam/test', mode='test',
                                transform=val_aug)
