...
from geoseg.models.ablation.CoTFormer_cot import CoTFormer
...
weights_name = "cottformer-cot-e120"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "cottformer-cot-e120"
...
val_dataset = VaihingenDataset(data_root='data/vaihingen/val', transform=val_aug)
